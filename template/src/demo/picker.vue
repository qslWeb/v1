...
<!--
slots绑定到 slots 属性的数组由对象组成，每个对象都对应一个 slot (相当于data,给组件绑定值与属性设置)

divider	对应 slot 是否为分隔符,为true则显示，false则隐藏分隔符

content	分隔符 slot 的显示文本 如本案例中的‘-’或改成文字‘到’
