...
<style>
   ...
   .page-loadmore-desc:last-of-type {border-bottom: solid 1px #eee;}
   .page-loadmore-listitem {
    ...
    .mint-spinner {display: inline-block;vertical-align: middle; }
   ...
   .mint-loadmore-top span {
    ...
    .mint-loadmore-top rotate {transform: rotate(180deg); }
